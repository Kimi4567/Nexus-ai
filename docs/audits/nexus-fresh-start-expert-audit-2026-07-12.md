...
أظهرت إعادة الاختبار أن التوليد أصبح ينجح بنيويًا، لكنها كشفت تسريبًا دلاليًا من fallback قديم خاص بمنتجات SaaS: عبارات مثل «عرض توضيحي» و«سير العمل» ظهرت داخل Funnel لعيادة أسنان. تم استبدال جميع fallbacks العامة في Strategy بعناصر محايدة مرتبطة بالعرض/الخدمة/المنتج، وتوسيع حارس الادعاءات ليخفف «العيادة المثالية» إلى صياغة ملاءمة غير مطلقة. كما تغير انتقال Content Hub من «مراجعة المسودات» إلى «إنشاء مسودات قابلة للمراجعة»، لأن تشغيل Strategy لا ينشئ أي مسودات مسبقًا.
