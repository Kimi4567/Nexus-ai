...
const STEPS: Step[] = [
  ...
  {
    id: 3,
    labelEn: 'Content Plan',
    labelAr: 'خطة المحتوى',
    descEn: 'Review drafted posts in Content Hub before scheduling or publishing',
    descAr: 'راجع مسودات المنشورات في مركز المحتوى قبل الجدولة أو النشر',
    icon: '📝',
    href: '/content-hub',
  ...
  },
  {
    ...
    descEn: 'Connect accounts when you are ready to review scheduling and publishing setup',
    descAr: 'اربط الحسابات عندما تكون جاهزاً لمراجعة إعداد الجدولة والنشر',
    icon: '📡',
    href: '/connections',
  ...
  },
  {
    ...
    labelAr: 'تحليل ونمو',
    descEn: 'Measure real performance and review analytics-backed signals',
    descAr: 'قِس الأداء الحقيقي وراجع إشارات مدعومة بالتحليلات',
    icon: '📊',
    href: '/analytics',
