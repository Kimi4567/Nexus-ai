...
export default function OnboardingChecklist({ stats, brandReadiness, hasConnections }: OnboardingChecklistProps) {
  ...
  const steps = [
    ...
    },
    {
      ...
      whyAr: 'بعد نشر المنشورات وتوفر التحليلات، يمكن لـ NEXUS اقتراح تعلميات لمراجعة Brand Brain.',
      whyEn: 'After posts are published and analytics are available, NEXUS can suggest learnings for Brand Brain review.',
      timeEstAr: '٢ دقيقة',
      timeEstEn: '2 min',
      href: '/connections',
      ctaAr: 'ربط المنصات',
