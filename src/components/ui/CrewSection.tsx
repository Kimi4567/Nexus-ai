...
const agents = [
  ...
  {name:'SENTINEL',role:'مُراقب المنافسة',desc:'يُراقب منافسيك 24/7. يكتشف استراتيجياتهم الجديدة، يُنذرك بالتهديدات، ويُحافظ على ميزتك التنافسية.',color:'#f43f5e',status:'جاهز للمراقبة'},
];
