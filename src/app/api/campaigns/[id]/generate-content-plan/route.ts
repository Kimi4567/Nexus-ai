...
Do not turn a confirmed delivery area into proof of doorstep or home delivery. Avoid "إلى منزلك", "إلى المنزل", and "إلى باب منزلك" unless that exact destination is explicitly user-confirmed.
Do not use Arabic guarantee constructions such as "لتضمن حصولك", "تضمن لك", or "يضمن لك". Use a factual review or subscription-details action instead.
