      ...
      <div className="doc">
        ...
        <div className="doc-header">
          <div>
            ...
            <div style={{ marginTop: 8, fontSize: 13, color: '#888' }}>
              {campaign.goal?.charAt(0) + campaign.goal?.slice(1).toLowerCase()} campaign
              &nbsp;·&nbsp; {campaign.tone}
              {campaign.platforms?.length > 0 && <>&nbsp;·&nbsp; {campaign.platforms.map(p => PLATFORM_ICONS[p] || p).join(', ')}</>}
            </div>
          </div>
          <div className="doc-meta">
            <div>Generated by Nexus AI</div>
            <div>{date}</div>
        ...
        <div className="section">
          <div className="agent-header sage">
            ...
            <span className="agent-title">· Lead Marketing Strategist</span>
          </div>

          {strategy.overview && (
            <div className="card">
              <div className="card-label">Strategic Overview</div>
          ...
          {strategy.ctaStrategies?.length > 0 && (
            <div className="card">
              <div className="card-label">CTA Strategies</div>
              <ul className="item-list" style={{ marginTop: 4 }}>
        ...
        {concepts.length > 0 && (
          <div className="section page-break">
            <div className="agent-header muse">
              ...
              <span className="agent-title">· Creative Director</span>
            </div>
            ...
            <div className="concepts-grid">
              {concepts.map((concept: any, i: number) => (
                <div key={i} className="concept-card">
                  ...
                  {concept.cta && (
                    <div className="cta-row">CTA: <strong>{concept.cta}</strong></div>
                  )}
                </div>
              ))}
            </div>
        ...
        <div className="doc-footer">
          ...
          <div className="footer-text">Generated by SAGE · MUSE · PULSE · PRISM — Your AI Marketing Department</div>
        </div>
      </div>
    </>
  )
