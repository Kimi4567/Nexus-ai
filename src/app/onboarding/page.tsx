      ...
      <Shell dir={dir}>
        <Panel>
          ...
          <p className="text-[13px] leading-relaxed mb-6" style={{ color: '#475569' }}>
            {ar
              ? 'لن يتم نشر أي محتوى أو إنفاق أي ميزانية بدون موافقتك.'
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl p-5" style={{ background: '#F5F3FF', border: '1px solid rgba(94,92,230,0.22)' }}>
            ...
            <p className="text-[13px] leading-relaxed mb-4" style={{ color: '#475569' }}>
              {ar
                ? 'بناءً على ذاكرة علامتك الحالية، يستطيع NEXUS توجيهك إلى الخطوة التسويقية التالية داخل لوحة التحكم. لم يتم إنشاء استراتيجية كاملة بعد، ولن يتم نشر محتوى أو إنفاق ميزانية بدون موافقتك.'
                : 'Based on your current Brand Brain, NEXUS can guide you to the next marketing step inside the dashboard. No full strategy has been created yet, and no content is published or budget spent without your approval.'}
            </p>
